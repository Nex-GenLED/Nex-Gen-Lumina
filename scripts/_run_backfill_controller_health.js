// _run_backfill_controller_health.js
//
// Invokes the DEPLOYED backfillControllerHealth callable (audit/COMMAND_SAFETY.md
...
//
// Usage:
//   node scripts/_run_backfill_controller_health.js --dry
//   node scripts/_run_backfill_controller_health.js --commit
...
async function main() {
  ...
  try {
    ...
    if (!resp.ok) {
      ...
      console.log('  backfillControllerHealth result');
      console.log('─'.repeat(64));
