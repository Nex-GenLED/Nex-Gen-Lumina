...
// WledLedBus / WledHardwareConfig moved to a pure-Dart file (bench/ CLI imports
// them without dart:ui); re-exported so existing importers are unaffected.
export 'package:nexgen_command/features/wled/wled_hardware_config.dart';
...
// WledLedBus + WledHardwareConfig live in wled_hardware_config.dart (pure Dart)
