...
// The NGL gamma standard + the cfg gamma chokepoint live in a pure-Dart file
...
// kNglLightGammaConfig + normalizeWledCfgPayload moved to the pure-Dart
// wled_cfg_gamma.dart (bench/ CLI imports it without dart:ui); re-exported
// from the directive block at the top of this file, so importers are unchanged.
