...
class LuminaAI {
  ...
  static const String _kSmartSystemPrompt =
      ...
      '- Tone: personal and warm, like a friend who gets you. Show you understood '
      '  the request — do NOT explain technical rationale or list effect names/speeds.\n'
      '- Good: "Royal blue and gold all week — your roofline is going to look incredible."\n'
      '- Bad: "I\'ve selected a Running effect at speed 150 with Royal Blue [0,70,135]..."\n'
      '- JSON schema: {"patternName":string,"thought":string,"colors":[{"name":string,"rgb":[R,G,B,W]}],'
      '"effect":{"name":string,"id":number,"direction":string,"isStatic":boolean},'
      '"speed":number,"intensity":number,"wled":object}\n'
      '- For saturated colors set W=0. Only use W>0 for warm/cool white.\n'
